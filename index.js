...
const nameSongs = [
	...
	"WILL I EVER", /*3*/
	"THE LONELY ONE", /*4*/
	"CELEBRATE OUR LOVE", /*5*/
	"MEGAMIX", /*6*/
	"CELEBRATE OUR LOVE", /*7*/
	"WHO NEEDS GUITARS ANYWAY?", /*8*/
	"ELEMENTS OF LIFE", /*9*/
	"BETTER OF", /*10*/
	"MEGAMIX EXTENDED", /*11*/
	"FAIRYTALES", /*12*/
	"WAITING FOR YOUR LOVE", /*13*/
	"NO MORE LIES", /*14*/
	"I CAN SEE", /*15*/
	"EVERYTHING BEGINS WITH AN E", /*16*/
	"GOT TO GET AWAY", /*17*/
	"ALICE DJ", /*18*/
	"BACK IN MY LIFE (INSTRUMENTAL)"/*19*/,
	"THE LONELY ONE", /*20*/
]
